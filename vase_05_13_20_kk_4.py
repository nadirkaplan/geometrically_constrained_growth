...
#time parameters 
T =int(round(40)) #int(round(25))            # final time
...
class Rate: #parameters of the growth rate
    def __init__(self):
        ...
        self.alpha3=Constant(1)  #(1.)
        self.eta1=Constant(1.)
        self.eta21=Constant(-0.5)
...
paramstring6='mm='+str(mm)

textfile=open(filenameparam, 'w')
textfile.write(paramstring1+paramstring2+paramstring3+paramstring4+paramstring5+paramstring6)
textfile.close()
